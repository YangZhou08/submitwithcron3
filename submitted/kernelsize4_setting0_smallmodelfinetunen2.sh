...
/data/home/beidic/anaconda3/envs/yangllm2/bin/accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 weird_training_addingextralarge.py --experiment_setting setting0 --kernel_size 4 --model_name llama2_7b --batch_size 16 --use_large_model --autoregressive_first_element 
