...
for threshold in ${thresholds[@]}; do
    accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --model xhf --model_args pretrained=meta-llama/Meta-Llama-3-8B-Instruct,cats=True,spr=0.3,check=True,kernel_size=16,thr=$threshold --tasks gsm8k --batch_size 1 --limit 0.5 
done
