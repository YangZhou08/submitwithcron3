...
accelerate launch --main_process_port 29510 --num_processes 8 --num_machines 1 main.py --model xhf --model_args pretrained=meta-llama/Llama-2-7b-chat-hf,griffin=True,check=True,griffinnotcats=False --tasks gsm8k,triviaqa,ifeval --batch_size 1 
